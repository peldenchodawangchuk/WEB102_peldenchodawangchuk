...
// @route   GET /api/posts
// @access  Public
exports.getPosts = asycnHandler(async (req, res, next) => {
    //Pagination
    ...
    const enhancedPosts = results.map(post => {
...
// @access  Public
exports.getPost = asycnHandler(async (req, res, next) => {
...
// @access  Private
exports.createPost = asycnHandler(async (req, res, next) => {
    ...
    const newPost = {
        ...
        userId: user.id,
        createdAt: new Date().toDISOString().slice(0, 10)
    };
...
//@access Private
exports.updatePost = asycnHandler(async (req, res, next) => {
    ...
    posts[index] = {
        ...
        userId: post.userId,//Ensure userId doesn't change
    };
...
// @access  Private  
exports.deletePost = asycnHandler(async (req, res, next) => {
    //Simulate authentication
    const userId = req.headers['x-user-id'];
    if (!userId) {
        return next(new ErrorResponse('Not authorized to access this route', 401));
